---
layout: post
title: SpringAnnotation-02-@ComponentScan包扫描&指定扫描规则
subheading: 
author: swang-harbin
categories: java
banner: 
...
---
# SpringAnnotation-02-@ComponentScan包扫描&指定扫描规则

创建BookController, BookService, BookDao, 并分别使用@Controller, @Service, @Repository注解标注
...
@Configuration
@ComponentScan(value = "zone.wwwww") // 扫描zone.wwwww及其子包, 将被@Controller, @Service, @Repository, @Component标注的组件扫描到容器
...
beans.xml中添加context:component-scan标签
...
xsi:schemaLocation="http://www.springframework.org/schema/beans http://www.springframework.org/schema/beans/spring-beans.xsd">
    ...
    <context:component-scan base-package="zone.wwwww"/>
...
@Configuration
// 扫描zone.wwwww包及其所有子包, 过滤掉被Controller注解和Service注解标注的类
@ComponentScan(value = "zone.wwwww", excludeFilters = {
...
@Configuration
// 扫描zone.wwwww包及其所有子包, 扫描时只扫描被Controller注解和Service注解标注的类
@ComponentScan(value = "zone.wwwww", includeFilters = {
// FilterType包含ANNOTATION, ASSIGNABLE_TYPE, ASPECTJ, REGEX, CUSTOM, 默认值是ANNOTATION
@ComponentScan.Filter(type = FilterType.ANNOTATION, classes = {Controller.class, Service.class})
},
// 不使用默认的扫描规则
...
xsi:schemaLocation="http://www.springframework.org/schema/beans http://www.springframework.org/schema/beans/spring-beans.xsd http://www.springframework.org/schema/context https://www.springframework.org/schema/context/spring-context.xsd">
    ...
    <context:component-scan base-package="zone.wwwww" use-default-filters="false">
...
import zone.wwwww.bean.Person;
import zone.wwwww.typefilter.MyTypeFilter;
import org.springframework.context.annotation.Bean;
import org.springframework.context.annotation.ComponentScan;
import org.springframework.context.annotation.Configuration;
import org.springframework.context.annotation.FilterType;
...
@Configuration
@ComponentScan(basePackages = "zone.wwwww",
includeFilters = {
...
测试类输出, zone.wwwww包下的每个类均被MyTypeFilter进行匹配

```shell
--->zone.wwwww.bean.Person
--->zone.wwwww.controller.BookController
--->zone.wwwww.dao.BookDao
--->zone.wwwww.service.BookService
--->zone.wwwww.typefilter.MyTypeFilter
org.springframework.context.annotation.internalConfigurationAnnotationProcessor
org.springframework.context.annotation.internalAutowiredAnnotationProcessor
org.springframework.context.annotation.internalRequiredAnnotationProcessor
org.springframework.context.annotation.internalCommonAnnotationProcessor
...
与注解版相同, 定义一个MyTypeFilter实现TypeFilter接口, 输出--->类名, 如果类名中包含"er", 返回true, 否则返回false, 即XxxService, Person等返回true

修改beans.xml的context:component-scan标签中context:include-filter标签的type和expression
...
xsi:schemaLocation="http://www.springframework.org/schema/beans http://www.springframework.org/schema/beans/spring-beans.xsd http://www.springframework.org/schema/context https://www.springframework.org/schema/context/spring-context.xsd">
    ...
    <context:component-scan base-package="zone.wwwww" use-default-filters="false">
        <context:include-filter type="custom" expression="zone.wwwww.typefilter.MyTypeFilter"/>
    </context:component-scan>
