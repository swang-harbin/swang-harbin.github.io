...
修改 MainConfig.java，为三个 DataSource 添加 `@Profile` 注解
...
**执行 IOCTest，会发现容器中没有任何 DataSource**
...
public class IOCTest {
    ...
    public static void main(String[] args) {
        /**
         * 因为带参数的 AnnotationConfigApplicationContext 构造器，直接注册并刷新容器，
         * 所以使用不带参数的 bean，添加自己处理代码
         *
...
设置 IOCTest 中环境为 prod

```java
applicationContext.getEnvironment().setActiveProfiles("prod")
```

程序没有任何输出，因为整个类都没有加载，所以类中的其他 bean 也都不会加载
