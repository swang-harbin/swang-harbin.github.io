---
title: SpringAnnotation-07-使用FactoryBean接口注册组件
...
# SpringAnnotation-07-使用FactoryBean接口注册组件
...
import zone.wwwww.bean.ColorFactoryBean;
...
bean1的类型为: class zone.wwwww.bean.Color
调用了ColorFactoryBean.getObject()...
bean1 == bean2: false
bean3的类型为: class zone.wwwww.bean.ColorFactoryBean
```
